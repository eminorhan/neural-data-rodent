...
def download_nwb_files(csv_file, output_dir):
    ...
    try:
        ...
        for session_id in session_ids:
            url = f"https://visual-behavior-neuropixels-data.s3.us-west-2.amazonaws.com/visual-behavior-neuropixels/behavior_ecephys_sessions/ecephys_session_{session_id}.nwb"
